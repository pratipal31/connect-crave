...
const menuData = {
  ...
  menu: [
    { id: 1, item: "Margherita Pizza", description: "Classic pizza with tomato sauce and mozzarella", price: 199, rating: 4.7, veg: true, image: "/margherita.jpg" },
    { id: 2, item: "Pepperoni Passion", description: "Loaded with spicy pepperoni and cheese", price: 349, rating: 4.8, veg: false, image: "/pepperoni.png" },
    { id: 3, item: "Veggie Paradise", description: "Garden-fresh vegetables on a cheesy base", price: 279, rating: 4.6, veg: true, image: "/paradise.png" },
    { id: 4, item: "Chicken Maximus", description: "Loaded with grilled chicken and spices", price: 399, rating: 4.9, veg: false, image: "/maximus.jpg" },
    { id: 5, item: "Cheese Burst Pizza", description: "Extra cheese in every bite", price: 329, rating: 4.7, veg: true, image: "/cheese.png" },
    { id: 6, item: "Tandoori Chicken Pizza", description: "Spicy tandoori chicken with onions", price: 379, rating: 4.8, veg: false, image: "/tandoori-chicken.jpg" },
    { id: 7, item: "Garlic Bread", description: "Soft bread with garlic butter", price: 99, rating: 4.5, veg: true, image: "/garlic-bread.jpg" },
    { id: 8, item: "Chicken Wings", description: "Crispy spiced chicken wings", price: 229, rating: 4.6, veg: false, image: "/chicken-wings.jpg" },
